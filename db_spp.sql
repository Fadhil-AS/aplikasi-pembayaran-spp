...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2020 at 06:13 PM
...
(4, '2020_10_08_135026_create_siswa_table', 1),
(5, '2020_10_08_141516_create_petugas_table', 1),
(6, '2020_10_08_142852_create_kelas_table', 1),
(7, '2020_10_08_144130_create_spp_table', 1),
(8, '2020_10_08_145314_create_pembayaran_table', 1),
(9, '2020_10_08_153427_add_foreign_key_from_siswa_to_kelas_table', 1),
(10, '2020_10_08_155521_add_foreign_key_from_pembayaran_table', 1);
...
ALTER TABLE `pembayaran`
  ...
  ADD CONSTRAINT `pembayaran_id_spp_foreign` FOREIGN KEY (`id_spp`) REFERENCES `siswa` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pembayaran_nisn_foreign` FOREIGN KEY (`nisn`) REFERENCES `siswa` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
